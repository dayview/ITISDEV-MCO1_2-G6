...
const mapNotification = notification => ({
    ...
    opportunityId: String(notification.opportunityId),
    opportunityName: notification.opportunityName,
    requirementKey: notification.requirementKey,
    requirementLabel: notification.requirementLabel,
    deadline: notification.deadline,
    daysRemaining: getDaysUntilDeadline(notification.deadline),
